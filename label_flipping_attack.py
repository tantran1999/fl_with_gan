...
from federated_learning.worker_selection import SelectNormalWorkers
...
if __name__ == '__main__':
    ...
    for experiment_id in range(START_EXP_IDX, START_EXP_IDX + NUM_EXP):
        run_exp(REPLACEMENT_METHOD, NUM_POISONED_WORKERS, KWARGS, SelectNormalWorkers(), experiment_id, EXPERIMENT_NAME)
